    ...
    <div class="home1">
      ...
      <div class="part2">
        ...
        <div class="morepart" @click="gotopage12">
          ...
          <div class="word1">
            <span>大数据采集与交互机器人</span>
          </div>
        </div>
        <div class="morepart">
          <div class="circlemore">
            <i class="ymq-icongongyezujian-zhishideng styleword"></i>
          </div>
          <div class="word1">
            <span>智能交通信号控制</span>
          </div>
...
export default {
  ...
  methods: {
    ...
    gotopage12 () {
      var url = 'http://zhongkeruitong.top/crawl'
      window.open(url, '_blank')
    },
    gotopage13 () {
...
<style scoped>
  ...
  .part3word {
    margin-top: 40px;color: #EDEDED;font-size: 30px;font-weight: bold
  }
  .line {
